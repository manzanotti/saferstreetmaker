...
export class SchoolStreetLayer implements IMapLayer {
    ...
    addMarker = (points: Array<L.LatLng>) => {
        const polyline = new L.Polyline(points, {
            ...
            .on('edit', (e) => {
                PubSub.publish(this._eventTopics.layerUpdatedTopic, SchoolStreetLayer.Id);
            });
    ...
    markerOnClick = (e) => {
        ...
        PubSub.publish(this._eventTopics.layerSelectedTopic, SchoolStreetLayer.Id);
    };
        ...
        const modalFilterAction = L['Toolbar2'].Action.extend({
            ...
            addHooks: () => {
                if (this.selected) {
                    ...
                    this.selected = false;
                    this.removeCursor();
                    PubSub.publish(this._eventTopics.layerDeselectedTopic, SchoolStreetLayer.Id);
                    return;
                }
