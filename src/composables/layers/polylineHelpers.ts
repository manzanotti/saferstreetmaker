...
import { getFeatureCoordinates, buildPolylinePointChanges } from './polylinePointDiff';
export { getFeatureCoordinates, buildPolylinePointChanges } from './polylinePointDiff';
export type { PolylinePointChange } from './polylinePointDiff';
