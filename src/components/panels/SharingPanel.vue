...
import SharingScopePrompt from './SharingScopePrompt.vue';
...
function onScopeChosen(scope: 'all' | 'group') {
    const group = shareScopeGroup.value ?? undefined;
    createShare(scope, group);
}
