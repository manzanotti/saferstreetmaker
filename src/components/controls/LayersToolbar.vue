...
import { useToolbarDockScale } from '../../composables/useToolbarDockScale';
...
const { buttonScales, registerDockButton, onDockMouseMove, onDockMouseLeave, startObserving } =
    useToolbarDockScale(toolbarRef);
