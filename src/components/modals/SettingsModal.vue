...
<template>
  <div class="modal">
    ...
    <div class="mb-2">
      ...
      <input id="zoom" type="text" class="border-solid" :value="settingsStore.zoom" readonly />
    </div>
    ...
    <div class="mb-2">
      ...
      <input
        ...
        class="border-solid"
        :value="
          settingsStore.centre ? `${settingsStore.centre.lat},${settingsStore.centre.lng}` : ''
        "
        readonly
      />
    </div>
    ...
    <div class="toggle flex justify-left mb-2">
      <div class="form-check form-switch flex items-center gap-2">
        ...
        <label class="form-check-label inline-block text-gray-800" for="read-only">Read-only</label>
      </div>
    </div>

    <div class="mb-2">
      <h4>Visible Layers</h4>
      <div v-for="layer in mapStore.layers" :key="layer.id" class="toggle flex justify-left mb-2">
