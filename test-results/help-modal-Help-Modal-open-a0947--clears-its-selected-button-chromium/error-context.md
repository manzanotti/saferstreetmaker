...
- Name: help-modal.spec.ts >> Help Modal >> opening help while another modal is open closes that modal and clears its selected button
- Location: tests/playwright/help-modal.spec.ts:63:9
